package example.springex.beanfind;

import example.springex.AppConfig;
...
public class ApplicationContextSameBeanFindTest {
    ...
    @Test
    @DisplayName("타입으로 조회시 같은 타입이 두개 이상 있으면 중복 오류 발생")
    ...
    @Configuration
    static class SameBeanConfig { //테스트 클래스 안에서만 사용한다는 뜻
